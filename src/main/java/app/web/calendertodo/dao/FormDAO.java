...
public class FormDAO {
	...
	public int insert(FormDatas formdatas) {
		String sql = "INSERT INTO formdatas(dataid, year, month, day, title, content) VALUES(?,?,?,?,?,?)";
		Object[] parameters = {formdatas.getDataid(), formdatas.getYear(), formdatas.getMonth(), formdatas.getDay(), formdatas.getTitle(), formdatas.getContent()};
